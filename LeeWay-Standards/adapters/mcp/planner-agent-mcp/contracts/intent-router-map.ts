...
5WH:
WHAT = Planner-scoped intent router map — intent-to-agent dispatch table for the planner agent
WHY = Provides the planner agent with its own authoritative routing configuration
WHO = Agent Lee OS — MCP System
WHERE = MCP agents/planner-agent-mcp/contracts/intent-router-map.ts
WHEN = 2026
HOW = Typed constant export implementing the IntentRouterMap contract
