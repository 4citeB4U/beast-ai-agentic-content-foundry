import { Capability, WorkflowRole, AgentOps } from "./capability-vocab.js";
...
5WH:
WHAT = Agent contracts — shared TypeScript type definitions for all MCP agent services
WHY = Provides a strongly-typed contract layer ensuring consistency across all agents
WHO = Agent Lee OS — MCP System
WHERE = MCP agents/contracts/agent-contracts.ts
WHEN = 2026
HOW = TypeScript type aliases and interfaces exported for use by all MCP agent implementations
